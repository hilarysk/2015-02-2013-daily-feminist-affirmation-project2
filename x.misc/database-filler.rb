...
a = User.new({"password"=>"codeschool", "username"=>"hilarysk"})
...
g = Keyword.new({"keyword"=>"Mindy Kaling"})
h = Keyword.new({"keyword"=>"Gloria Steinem"})
i = Keyword.new({"keyword"=>"Malala Yousafzai"})
j = Keyword.new({"keyword"=>"Audre Lorde"})
k = Keyword.new({"keyword"=>"Lupita Nyong`o"})
l = Keyword.new({"keyword"=>"Sarah Silverman"})
m = Keyword.new({"keyword"=>"Virginia Woolf"})
n = Keyword.new({"keyword"=>"Amy Poehler"})
o = Keyword.new({"keyword"=>"Alberta Williams King"})
p = Keyword.new({"keyword"=>"Kirsten Gillibrand"})
qr = Keyword.new({"keyword"=>"Fannie Lou Hamer"})
qs = Keyword.new({"keyword"=>"Dolores Huerta"})
qt = Keyword.new({"keyword"=>"Christine de Pizan"})
qu = Keyword.new({"keyword"=>"Juana Inés de la Cruz"})
qv = Keyword.new({"keyword"=>"Fannie Lou Hamer"})
qw = Keyword.new({"keyword"=>"Julie Ruin"})
q = Keyword.new({"keyword"=>"Pakistan"})
r = Keyword.new({"keyword"=>"book"})
s = Keyword.new({"keyword"=>"song"})
t = Keyword.new({"keyword"=>"Beloved"})
u = Keyword.new({"keyword"=>"comedian"})
...
bb = Keyword.new({"keyword"=>"Julie Ruin"})
...
jj = Keyword.new({"keyword"=>"The Indelicates"})
kk = Keyword.new({"keyword"=>"Kate Chopin"})
ll = Keyword.new({"keyword"=>"The Awakening"})
...
a = Quote.new({"quote"=>"The stuggle is eternal. The tribe increase. Somebody else carries on.", "person_id"=>"1"})
e = Quote.new({"quote"=>"I think people are well aware that they have a right to come forward [about sexual harassment]. But many people have a fear that the processes will not give them a fair hearing. Even for those who complain, I think we’ve fallen down in terms of the investigative process. We still have a lot of challenges in terms of making sure that the people who are found guilty of harassment suffer the consequences of their behavior.", "person_id"=>"3"})
b = Quote.new({"quote"=>"My underlying goal was always to empower women. Get them to learn their rights, and to exercise them!", "person_id"=>"5"})
c = Quote.new({"quote"=>"Though we have the courage to raise our daughters more like our sons, we''ve rarely had the courage to raise our sons more like our daughters.", "person_id"=>"6"})
d = Quote.new({"quote"=>"We cannot all succeed when half of us are held back.", "person_id"=>"7"})


f = Quote.new("quote"=>"I am not free while any woman is unfree, even when her shackles are very different from my own.", "person_id"=>"8"}) #audre lorde
g = Quote.new({"quote"=>"As soon as a woman gets to an age where she has opinions and she''s vital and she''s strong, she''s systematically shamed into hiding under a rock.", "person_id"=>"11"}) #sarah silverman
h = Quote.new({"quote"=>"For most of history, \"Anonymous\" was a woman.", "person_id"=>"12"}) #virginia woolf
...
c = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"1", "item_table_id"=>"3"})
d = KeywordItem.new({"keyword_id"=>"29", "item_id"=>"1", "item_table_id"=>"3"})
e = KeywordItem.new({"keyword_id"=>"24", "item_id"=>"1", "item_table_id"=>"3"})
f = KeywordItem.new({"keyword_id"=>"6", "item_id"=>"1", "item_table_id"=>"3"})
g = KeywordItem.new({"keyword_id"=>"43", "item_id"=>"2", "item_table_id"=>"3"})   #awakening excerpt
ha = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"2", "item_table_id"=>"3"})
h = KeywordItem.new({"keyword_id"=>"44", "item_id"=>"2", "item_table_id"=>"3"})
i = KeywordItem.new({"keyword_id"=>"29", "item_id"=>"2", "item_table_id"=>"3"})
j = KeywordItem.new({"keyword_id"=>"24", "item_id"=>"2", "item_table_id"=>"3"})
k = KeywordItem.new({"keyword_id"=>"1", "item_id"=>"1", "item_table_id"=>"1"})   #ella baker
l = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"1", "item_table_id"=>"1"})
m = KeywordItem.new({"keyword_id"=>"36", "item_id"=>"1", "item_table_id"=>"1"})
n = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"1", "item_table_id"=>"1"})
o = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"1", "item_table_id"=>"1"})
p = KeywordItem.new({"keyword_id"=>"3", "item_id"=>"2", "item_table_id"=>"1"})   #barbara milkowski
q = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"2", "item_table_id"=>"1"})
r = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"2", "item_table_id"=>"1"})
s = KeywordItem.new({"keyword_id"=>"37", "item_id"=>"2", "item_table_id"=>"1"})
t = KeywordItem.new({"keyword_id"=>"37", "item_id"=>"3", "item_table_id"=>"1"})   #anita hill
u = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"3", "item_table_id"=>"1"})
v = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"3", "item_table_id"=>"1"})
w = KeywordItem.new({"keyword_id"=>"4", "item_id"=>"3", "item_table_id"=>"1"})
x = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"3", "item_table_id"=>"1"})
y = KeywordItem.new({"keyword_id"=>"2", "item_id"=>"4", "item_table_id"=>"1"})   #ida wells
z = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"4", "item_table_id"=>"1"})
a = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"4", "item_table_id"=>"1"})
b = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"4", "item_table_id"=>"1"})
c = KeywordItem.new({"keyword_id"=>"36", "item_id"=>"4", "item_table_id"=>"1"})
d = KeywordItem.new({"keyword_id"=>"33", "item_id"=>"4", "item_table_id"=>"1"})
e = KeywordItem.new({"keyword_id"=>"5", "item_id"=>"5", "item_table_id"=>"1"})   #mildred
f = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"5", "item_table_id"=>"1"})
g = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"5", "item_table_id"=>"1"})
h = KeywordItem.new({"keyword_id"=>"39", "item_id"=>"5", "item_table_id"=>"1"})
i = KeywordItem.new({"keyword_id"=>"36", "item_id"=>"5", "item_table_id"=>"1"})
j = KeywordItem.new({"keyword_id"=>"37", "item_id"=>"5", "item_table_id"=>"1"})
k = KeywordItem.new({"keyword_id"=>"8", "item_id"=>"6", "item_table_id"=>"1"})   #gloria steinem
l = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"6", "item_table_id"=>"1"})
m = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"6", "item_table_id"=>"1"})
n = KeywordItem.new({"keyword_id"=>"9", "item_id"=>"7", "item_table_id"=>"1"})   #malala
o = KeywordItem.new({"keyword_id"=>"23", "item_id"=>"7", "item_table_id"=>"1"})
p = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"7", "item_table_id"=>"1"})
q = KeywordItem.new({"keyword_id"=>"43", "item_id"=>"8", "item_table_id"=>"1"})   #kate chopin
r = KeywordItem.new({"keyword_id"=>"44", "item_id"=>"8", "item_table_id"=>"1"})
s = KeywordItem.new({"keyword_id"=>"35", "item_id"=>"8", "item_table_id"=>"1"})
t = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"8", "item_table_id"=>"1"})
u = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"8", "item_table_id"=>"1"}) 
v = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"10", "item_table_id"=>"1"})  #dolores huerta
w = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"10", "item_table_id"=>"1"})
x = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"10", "item_table_id"=>"1"})  #toni morrison
y = KeywordItem.new({"keyword_id"=>"39", "item_id"=>"10", "item_table_id"=>"1"})
z = KeywordItem.new({"keyword_id"=>"18", "item_id"=>"10", "item_table_id"=>"1"})
ab = KeywordItem.new({"keyword_id"=>"28", "item_id"=>"9", "item_table_id"=>"1"})
ac = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"9", "item_table_id"=>"1"})
ad = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"9", "item_table_id"=>"1"})
...
c = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"1", "item_table_id"=>"4"}) 
d = KeywordItem.new({"keyword_id"=>"31", "item_id"=>"2", "item_table_id"=>"4"})  #lived experience
e = KeywordItem.new({"keyword_id"=>"31", "item_id"=>"3", "item_table_id"=>"4"})  #privilege
f = KeywordItem.new({"keyword_id"=>"31", "item_id"=>"4", "item_table_id"=>"4"})  #gender binary
g = KeywordItem.new({"keyword_id"=>"38", "item_id"=>"4", "item_table_id"=>"4"})
h = KeywordItem.new({"keyword_id"=>"31", "item_id"=>"5", "item_table_id"=>"4"})  #schrodinger's rapist
i = KeywordItem.new({"keyword_id"=>"31", "item_id"=>"6", "item_table_id"=>"4"})   #mansplain
j = KeywordItem.new({"keyword_id"=>"1", "item_id"=>"1", "item_table_id"=>"2"})    #struggle is eternal
kk = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"1", "item_table_id"=>"2"}) 

k = KeywordItem.new({"keyword_id"=>"36", "item_id"=>"1", "item_table_id"=>"2"}) 
l = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"1", "item_table_id"=>"2"})
m = KeywordItem.new({"keyword_id"=>"30", "item_id"=>"1", "item_table_id"=>"2"})
n = KeywordItem.new({"keyword_id"=>"33", "item_id"=>"1", "item_table_id"=>"2"})
o = KeywordItem.new({"keyword_id"=>"30", "item_id"=>"2", "item_table_id"=>"2"})   #people well aware have right

p = KeywordItem.new({"keyword_id"=>"41", "item_id"=>"2", "item_table_id"=>"2"})
q = KeywordItem.new({"keyword_id"=>"37", "item_id"=>"2", "item_table_id"=>"2"})
r = KeywordItem.new({"keyword_id"=>"4", "item_id"=>"2", "item_table_id"=>"2"})
s = KeywordItem.new({"keyword_id"=>"5", "item_id"=>"3", "item_table_id"=>"2"})   #empower women
t = KeywordItem.new({"keyword_id"=>"37", "item_id"=>"3", "item_table_id"=>"2"})
u = KeywordItem.new({"keyword_id"=>"39", "item_id"=>"3", "item_table_id"=>"2"})
v = KeywordItem.new({"keyword_id"=>"30", "item_id"=>"3", "item_table_id"=>"2"})
w = KeywordItem.new({"keyword_id"=>"30", "item_id"=>"4", "item_table_id"=>"2"})  #raise sons ilke daughters

x = KeywordItem.new({"keyword_id"=>"8", "item_id"=>"4", "item_table_id"=>"2"})
y = KeywordItem.new({"keyword_id"=>"30", "item_id"=>"5", "item_table_id"=>"2"})   # we cannot al succeed
z = KeywordItem.new({"keyword_id"=>"5", "item_id"=>"5", "item_table_id"=>"2"})
za = KeywordItem.new({"keyword_id"=>"23", "item_id"=>"5", "item_table_id"=>"2"})


kp = KeywordItem.new({"keyword_id"=>"40", "item_id"=>"2", "item_table_id"=>"2"}) 
