...
# Keyword.create({"keyword"=>"Barbara Mikulski"})
# Keyword.create({"keyword"=>"Anita Hill"})
# Keyword.create({"keyword"=>"Mildred Jeffrey"})
# Keyword.create({"keyword"=>"Toni Morrison"})
# Keyword.create({"keyworcreated"=>"Mindy Kaling"})
# Keyword.create({"keyword"=>"Gloria Steinem"})
# Keyword.create({"keyword"=>"Malala Yousafzai"})
# Keyword.create({"keyword"=>"Audre Lorde"})
# Keyword.create({"keyword"=>"Lupita Nyong`o"})
# Keyword.create({"keyword"=>"Sarah Silverman"})
# Keyword.create({"keyword"=>"Virginia Woolf"})
# Keyword.create({"keyword"=>"Amy Poehler"})
# Keyword.create({"keyword"=>"Alberta Williams King"})
# Keyword.create({"keyword"=>"Kirsten Gillibrand"})
# Keyword.create({"keyword"=>"Fannie Lou Hamer"})
# Keyword.create({"keyword"=>"Dolores Huerta"})
# Keyword.create({"keyword"=>"Christine de Pizan"})
# Keyword.create({"keyword"=>"Juana Inés de la Cruz"})
# Keyword.create({"keyword"=>"Fannie Lou Hamer"})
# Keyword.create({"keyword"=>"Julie Ruin"})
# Keyword.create({"keyword"=>"Pakistan"})
# Keyword.create({"keyword"=>"book"})
# Keyword.create({"keyword"=>"song"})
# Keyword.create({"keyword"=>"Beloved"})
# Keyword.create({"keyword"=>"comedian"})
# Keyword.create({"keyword"=>"person"})
# Keyword.create({"keyword"=>"excerpt"})
# Keyword.create({"keyword"=>"quote"})
# Keyword.create({"keyword"=>"term"})
# Keyword.create({"keyword"=>"Kimberlé Crenshaw"})
# Keyword.create({"keyword"=>"history"})
# Keyword.create({"keyword"=>"Julie Ruin"})
# Keyword.create({"keyword"=>"author"})
# Keyword.create({"keyword"=>"civil rights"})
# Keyword.create({"keyword"=>"politics"})
# Keyword.create({"keyword"=>"LGBTQ"})
# Keyword.create({"keyword"=>"labor"})
# Keyword.create({"keyword"=>"United States"})
# Keyword.create({"keyword"=>"people of color"})
# Keyword.create({"keyword"=>"The Indelicates"})
# Keyword.create({"keyword"=>"Kate Chopin"})
# Keyword.create({"keyword"=>"The Awakening"})
#
# EX = Keyword.create({"keyword"=>""})
#
...
# terms:
#
# Term.create({"term"=>"intersectional feminism", "definition"=>"Coined by black legal scholar Kimberlé Crenshaw in 1989, \"intersectionality\" refers to the intersections of different forms or systems of oppression. For modern feminism, it means bringing groups of women to the table who have often been marginalized by mainstream feminist movements, and by recognizing that the difficulties women of color face, or women with disabilities, or LGBTQ women, or poor women face can be very different than those faced by white, able-bodied, straight, middle-class women; and that their voices must no longer be silenced, and their struggles no longer ignored. Essentially, it''s the idea that there is no \"one size fits all\" feminism.", "phonetic"=>"ˌɪntərˈsɛkʃən(ə)l ˈfɛmɪˌnɪzəm"})
# #ˌɪntərˈsɛkʃən(ə)l ˈfɛmɪˌnɪzəm
# &#x02CC;&#x026A;nt&#x0259;r&#x02C8;s&#x025B;k&#x0283;&#x0259;n(&#x0259;)l &#x02C8;f&#x025B;m&#x026A;&#x02CC;n&#x026A;z&#x0259;m
# Term.create({"term"=>"lived experience", "definition"=>"As contrasted with observed experience, \"lived experience\" refers to the experiences of people who live as members of a minority or oppressed group. People often discount the struggles women face simply because the outsider has no firsthand experience with such struggles, and so therefore, they don''t believe that they happen.", "phonetic"=>"laɪvd ɪkˈspɪriəns"})
# #laɪvd ɪkˈspɪriəns
# la&#x026A;vd &#x026A;k&#x02C8;sp&#x026A;ri&#x0259;ns
# Term.create({"term"=>"privilege", "definition"=>"Privilege refers to advantages conferred on people based soley on social status - such as white privilege, male privilege, able-bodied privilege. You can enjoy the benefits of being white, for example, while still facing challenges (such as poverty). Being privileged in one sector of your life does not erase challenges in others. But without being aware of one''s own privilege, a person can''t be an effective ally.", "phonetic"=>"ˈprɪvləʤ"})
# #ˈprɪvləʤ
# &#x02C8;pr&#x026A;vl&#x0259;&#x02A4;
# Term.create({"term"=>"gender binary", "definition"=>"A gender binary system is a social system that only recognizes two \"legitimate\" gender identities or gender expressions, namely masculine and feminine.", "phonetic"=>"ˈʤɛndər ˈbaɪnəri"})
# #ˈʤɛndər ˈbaɪnəri
# &#x02C8;&#x02A4;&#x025B;nd&#x0259;r &#x02C8;ba&#x026A;n&#x0259;ri
# Term.create({"term"=>"Schrödinger''s rapist", "definition"=>"\"So when you, a stranger, approach me, I have to ask myself: Will this man rape me?\"<br><br>The concept of Schrödinger''s rapist <a href=\"http://kateharding.net/2009/10/08/guest-blogger-starling-schrodinger%E2%80%99s-rapist-or-a-guy%E2%80%99s-guide-to-approaching-strange-women-without-being-maced/\">was introduced</a> by Phaedra Starling in 2009, and references the thought experiment Schrödinger''s cat, which essentially posits a situation where a cat may or may not die based on a random event, the outcome of which cannot be predicted. Starling''s essay tells men interested in approaching women that, to them, the men may or may not wish them physical harm - they have no way of knowing, and therefore, all men are potential rapists.", "phonetic"=>"ʃröˈdɪŋərz ˈreɪpɪst"})
# #ʃröˈdɪŋərz ˈreɪpɪst
# &#x0283;r&#x00F6;&#x02C8;d&#x026A;&#x014B;&#x0259;rz &#x02C8;re&#x026A;p&#x026A;st
# Term.create({"term"=>"mansplain", "definition"=>"A portmanteau of \"man\" and \"explain,\" it refers to men explaining something they have little knowledge of to women in a condescending manner - specifically, topics related to women - because they assume that the woman knows even less.", "phonetic"=>"mænspleɪn"})
# #mænspleɪn
# m&#x00E6;nsple&#x026A;n
#
# h = Term.create({"term"=>"rape culture", "definition"=>"", "phonetic"=>"reɪp ˈk}ʌlʧər"})
# i = Term.create({"term"=>"reverse sexism", "definition"=>"", "phonetic"=>"rɪˈvɜrs ˈsɛksɪzəm"})
# j = Term.create({"term"=>"confirmation bias", "definition"=>"", "phonetic"=>"ˌkɑnfərˈmeɪʃən ˈbaɪəs"})
# k = Term.create({"term"=>"internalized sexism", "definition"=>"", "phonetic"=>"ɪnˈtɜrnəˌlaɪzd ˈsɛksɪzəm"})
# e = Term.create({"term"=>"male gaze", "definition"=>"", "phonetic"=>"meɪl geɪz"})
# g = Term.create({"term"=>"lean in", "definition"=>"", "phonetic"=>"lin ɪn"})
#
#
#
# EX = Term.create({}"term"=>"", "definition"=>"", "phonetic"=>""})
#
#
#
# excerpts:
#
# Excerpt.create({"excerpt"=>"And if she thought anything, it was No. No. Nono. Nonono. Simple. She just flew. Collected every bit of life she had made, all the parts of her that were precious and fine and beautiful, and carried, pushed, dragged them through the veil, out, away, over there where no one could hurt them. Over there. Outside this place, where they would be safe.", "source"=>"Beloved", "person_id"=>"9"})
# Excerpt.create({"excerpt"=>"I would give up the unessential; I would give up my money, I would give up my life for my children; but I wouldn''t give myself. I can''t make it more clear; it''s only something I am beginning to comprehend, which is revealing itself to me.", "source"=>"The Awakening", "person_id"=>"8"})
# Excerpt.create({"excerpt"=>"We liked to be known as the clever girls. When we decorated our hands with henna for holidays and weddings, we drew calculus and chemical formulae instead of flowers and butterflies.", "source"=>"I Am Malala: The Girl Who Stood Up for Education and Was Shot by the Taliban", "person_id"=>"7"})
# Excerpt.create({"excerpt"=>"She sometimes feels that her years as a man junkie took irreplaceable time away from her music, and wonders what women could be if, as she puts it, ''We stopped taking care of men so they will take care of us - and put the same amount of time into taking care of ourselves.''", "source"=>"Revolution From Within: A Book of Self-Esteem", "person_id"=>"6"})
#
#
# http://www.joannadevoe.com/2014/04/book-nerd-weekly-kickass-quotes-from_28.html
#
#
# b = Excerpt.create({"excerpt"=>"How many girls stay awake all night<br>too scared to sleep and too scared to fight back<br>I know you know what I''m talking about<br>another woman killed and hardly a pout about it<br>green river killer my f**king a**<br>the cops have gotta be deaf, dumb, and spastic<br>to not catch the killer(s) of one hundred women<br>I guess it''d be different if they thought we were human<br><br>I wanna know what love is.", "source"=>"\"I Wanna Know What Love Is\"", "person_id"=>"21"}) #julie ruin
# c = Excerpt.create({"excerpt"=>"Rape us and beat us ''til we''re black and blue<br>We made it ok on the day we said nothing<br>Was better than something to say<br><br>What our foremothers fought for was peachy and swell<br>But hey they forgot to be mothers as well<br>Instead of our fathers, our sisters did say:Let''s just be pretty, it''s more fun that way<br><br>Let''s just be pretty<br>Let''s just be beautiful<br>Let''s just be retro and disco and twee<br>We don''t know the song so we can''t sing along<br>And our daughters will never be free.", "source"=>"Our Daughters Will Never Be Free", "person_id"=>"22"}) #the indelicates
#
# a = Excerpt.create({"excerpt"=>"But was it really like that? As painful as I remember? Only mildly. Or rather, it was a productive and fructifying pain. Love, thick and dark as Alaga syrup, eased up into that cracked window. I could smell it - taste it - sweet, musty, with an edge of wintergreen in its base - everywhere in that house. It stuck, along with my tongue, to the frosted windowpanes. It coated my chest, along with the salve, and when the flannel came undone in my sleep, the clear, sharp curves of air outlined its presence on my throat. And in the night, when my coughing was dry and tough, feet padded into the room, hands repinned the flannel, readjusted the quilt, and rested a moment on my forehead. So when I think of autumn, I think of somebody with hands who does not want me to die.", "source"=>"The Bluest Eye", "person_id"=>"9"})
# EX = Excerpt.create({"excerpt"=>"", "source"=>"", "person_id"=>""})
#
# EX = Excerpt.create({"excerpt"=>"", "source"=>"", "person_id"=>""})
#
#
...
# keyword_items:
#
# KeywordItem.create({"keyword_id"=>"26", "item_id"=>"1", "item_type"=>"Excerpt"})   #Beloved excerpt
...
# KeywordItem.create({"keyword_id"=>"43", "item_id"=>"2", "item_type"=>"Excerpt"})   #awakening excerpt
...
# KeywordItem.create({"keyword_id"=>"3", "item_id"=>"2", "item_type"=>"Person"})   #barbara milkowski
...
# KeywordItem.create({"keyword_id"=>"37", "item_id"=>"3", "item_type"=>"Person"})   #anita hill
...
# KeywordItem.create({"keyword_id"=>"2", "item_id"=>"4", "item_type"=>"Person"})   #ida wells
...
# KeywordItem.create({"keyword_id"=>"5", "item_id"=>"5", "item_type"=>"Person"})   #mildred
...
# KeywordItem.create({"keyword_id"=>"28", "item_id"=>"10", "item_type"=>"Person"})  #dolores huerta
# KeywordItem.create({"keyword_id"=>"40", "item_id"=>"10", "item_type"=>"Person"})
# KeywordItem.create({"keyword_id"=>"41", "item_id"=>"10", "item_type"=>"Person"})  #toni morrison
...
# KeywordItem.create({"keyword_id"=>"30", "item_id"=>"2", "item_type"=>"Quote"})   #Person well aware have right
#
...
# KeywordItem.create({"keyword_id"=>"5", "item_id"=>"3", "item_type"=>"Quote"})   #empower women
...
# KeywordItem.create({"keyword_id"=>"30", "item_id"=>"4", "item_type"=>"Quote"})  #raise sons ilke daughters
#
# KeywordItem.create({"keyword_id"=>"8", "item_id"=>"4", "item_type"=>"Quote"})
# KeywordItem.create({"keyword_id"=>"30", "item_id"=>"5", "item_type"=>"Quote"})   # we cannot al succeed
...
#
#
# EX = KeywordItem.create({"keyword_id"=>"", "item_id"=>"", "item_type"=>""})
#
# .save
